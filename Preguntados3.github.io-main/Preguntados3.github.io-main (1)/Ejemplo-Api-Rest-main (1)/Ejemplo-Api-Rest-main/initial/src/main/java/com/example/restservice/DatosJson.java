...
public class DatosJson extends Acceso {
    ...
    public HashMap<String, Integer>obtenerHighScore(){
        this.conectarABaseDeDatos("TpIntegrador");
        this.conectarAColeccion("pagina");
    ...
    public void actualizarHighScore(String mail, Integer score){
        this.conectarABaseDeDatos("TpIntegrador");
        this.conectarAColeccion("pagina");
        FindIterable resultado = this.getColeccion().find();
        MongoCursor iterador = resultado.iterator();
        while (iterador.hasNext()){
            Document document = (Document) iterador.next();
            String mailBUscado = (String) document.getString("mail");
                System.out.println(mailBUscado);
                System.out.println(mail);
                Integer highScorePrevio = (Integer) document.get("highScore");
                Bson filtro = eq("mail", mail);
                Document nuevoHighscore = new Document("highScore", score);
                Document operacion = new Document("$set", nuevoHighscore);
                if(score > highScorePrevio){
                    this.getColeccion().updateOne(filtro, operacion);
                }
            }
        }
